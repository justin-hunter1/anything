...
// randomizer option
var radomizerValue = document.querySelector("#RANDOM");
...
radomizerValue.addEventListener("click", function() {
  userCategories.textContent = "Random"
  userChosen.textContent = "Random"
});